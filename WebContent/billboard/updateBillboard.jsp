...
<html lang="">
	...
	<body >	
		<h3>公佈欄資料:</h3>
		<s:form action="updateBillboard" namespace="/billboard" >
		    <s:hidden name="billboardVO.bill_id" label="編號" value="%{#request.billboardVO.bill_id}"  readonly="true" cssStyle="background:gray" />
			<s:textfield name="billboardVO.bill_title"   label="標題" value="%{#request.billboardVO.bill_title}"/>				
			...
			<s:textfield name="billboardVO.bill_name"   label="公佈者" value="%{#request.billboardVO.bill_name}" readonly="true" />
			<s:textarea  cols="80" rows="10" id="editor1" name="billboardVO.bill_content"  label="公佈欄內容" value="%{#request.billboardVO.bill_content}" />
